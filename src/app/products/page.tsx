        ...
        <div className="container !pb-0">
          <div className="shadow-[0px_4px_11.1px_0px_#00000040] rounded-2xl  flex justify-between p-5">
            <div className="   flex flex-col w-[30%]">
              ...
              <button className="bg-primary px-8 py-3 rounded mb-0">
            ...
            <div className="w-[50%]">
              <div className=" grid grid-cols-3 gap-5">
                <div className=" bg-[#F0EFE9] border border-primary rounded-[8px] overflow-hidden p-4">
                  <Image
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-3 gap-5 items-stretch">
            ...
            <div className="shadow-[0px_4px_11.1px_0px_#00000040] rounded-2xl p-5 h-full flex flex-col">
              ...
              <button className="bg-primary px-8 py-3 rounded mb-5 mt-auto">
                <span className="text-[#E9DCB4] font-semibold text-base">
                  Explore Now
                </span>
              </button>
