            ...
            <div>
              ...
              <div>
                <Image
                  ...
                  width={500}
                  height={1000}
                  alt="Air Data Test System for aircraft calibration by Jetsys Defence"
                    ...
                    <table className="min-w-full table-auto">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="px-4 py-2 border-b">0.1 – 60 inHg; resolution 0.001 inHg; accuracy ±0.003 inHg</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border-b">Altitude Range</td>
                          <td className="px-4 py-2 border-b">–4,000 to 60,000 ft; resolution 1 ft; accuracy ±2 ft @ 0 ft / ±6 ft @ 35,000 ft / ±12 ft @ 50,000 ft</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border-b">Airspeed Range</td>
                          <td className="px-4 py-2 border-b">0 – 650 knots; resolution 0.1 kt; accuracy ±0.5 kt @ 50 kt / ±0.25 kt @ 100 kt / ±0.05 kt @ 650 kt</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border-b">Mach Function</td>
                          <td className="px-4 py-2 border-b">0.00 – 3.00 M; resolution 0.001 M; accuracy ±0.001 above 0.2 Mach</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="px-4 py-2 border-b">Automated detection during pressure stabilization</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border-b">Remote Operation</td>
                          <td className="px-4 py-2 border-b">Available (via cockpit or portable unit)</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="px-4 py-2 border-b">Automatic shutoff on large leaks; power failure protection</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border-b">Connectivity</td>
                          <td className="px-4 py-2 border-b">RS-232; IEEE-488 (configurable)</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border-b">Calibration</td>
                          <td className="px-4 py-2 border-b">Annual calibration recommended for optimal accuracy</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border-b">Compliance</td>
                          <td className="px-4 py-2 border-b">RVSM-compliant, FAA, EASA, ICAO standards</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <div className="text-black space-y-4">
                      <ul className="list-disc pl-5">
                        <li>
                          ...
                          We provide setup assistance, troubleshooting, and scheduled calibration support to ensure your {" "}
                          <Link href="/products/aviation-equipment/ground-test-equipment/air-data-test-system/pitot_static_test_equipment" className="hover:underline no-underline text-inherit">
                            Pitot Static Test Equipment
                          </Link> operates flawlessly across its service life.
                        </li>
                      </ul>
                    </div>
                  </div> 
