...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.jetsys.co.in/products/aviation-equipment/ground-test-equipment/brake-valve-test-rig",
  },
};
          ...
          <div className="container">
            <div>
              <h1 className="text-primary text-[26px] md:text-[40px] font-extrabold uppercase mb-5 horizon">
                Brake Valve Test Rig for Aircraft – Precision Hydraulic Testing by Jetsys Defence
              </h1>
                ...
                <div className="mx-auto">
                  ...
                  <div className="overflow-x-auto bg-white rounded-lg">
                    <table className="min-w-full table-auto">
                      ...
                      <tbody>
                        <tr><td className="px-4 py-2 border-b">Hydraulic Pressure Range</td><td className="px-4 py-2 border-b">0 – 1,060 kg/cm² (±0.5% regulation)</td></tr>
                        <tr><td className="px-4 py-2 border-b">Pneumatic Pressure Range</td><td className="px-4 py-2 border-b">0 – 10 kg/cm² (≤ 5 °C dew point)</td></tr>
                        ...
                        <tr><td className="px-4 py-2 border-b">Safety Compliance</td><td className="px-4 py-2 border-b">IEC 60204-1, IS 325, IS 1248 standards</td></tr>
                        <tr><td className="px-4 py-2 border-b">Connectivity</td><td className="px-4 py-2 border-b">OPC-UA, Ethernet, Remote Monitoring</td></tr>
                        <tr><td className="px-4 py-2 border-b">Operating Temperature</td><td className="px-4 py-2 border-b">5 °C – 40 °C (indoor use)</td></tr>
                      </tbody>
                    </table>
                  </div>
                </div>
              ...
              <section><br /><br />
                <div>
                  <h3 className="font-bold text-3xl text-[#5C5649] mb-5">Related Aviation Testing Solutions</h3>
                  <p className="text-black mb-4">
                    Jetsys Defence offers a comprehensive range of aviation ground support and testing equipment. Explore our related solutions:
                  </p>
                  <ul className="list-disc pl-5 text-black space-y-2">
                    <li>
                      <Link href="/products/aviation-equipment/ground-test-equipment/brake-valve-test-rig/aircraft_brake_system_test_rig" className="text-primary hover:underline font-semibold">
                        Aircraft Brake System Test Rig
                    ...
                    <li>
                      <Link href="/products/aviation-equipment/ground-test-equipment/brake-valve-test-rig/pneumatic_test_rig" className="text-primary hover:underline font-semibold">
                        Pneumatic Test Rig
                      </Link> – Advanced pneumatic testing for air-based aircraft systems.
                    </li>
                  </ul>
                </div>
              </section>
