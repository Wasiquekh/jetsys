                  ...
                  <div className="text-black space-y-4">
                    <ul className="list-disc pl-5">
                      ...
                      <li>
                        ...
                        <a href="/products/aviation-equipment/ground-supply-equipment/ground-power-unit/400hz-ground-power-unit" className="hover:underline" style={{ color: 'inherit' }}>400 Hz 115/200 V AC</a> plus <a href="/products/aviation-equipment/ground-supply-equipment/ground-power-unit/28.5vdc-ground-power-unit" className="hover:underline" style={{ color: 'inherit' }}>28.5 V DC</a> modes support aircraft power-up, testing, avionics servicing, and line maintenance.
                      </li>
                      <li>
                  ...
                  <table className="min-w-full table-auto">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="px-4 py-2 border-b">115 V (L-N), 200 V (L-L), <a href="/products/aviation-equipment/ground-supply-equipment/ground-power-unit/400hz-ground-power-unit" className="hover:underline" style={{ color: 'inherit' }}>400 Hz</a> (3-phase, 4-wire)</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-4 py-2 border-b"><a href="/products/aviation-equipment/ground-supply-equipment/ground-power-unit/28.5vdc-ground-power-unit" className="hover:underline" style={{ color: 'inherit' }}>28.5 V DC</a> continuous 800 A, 5-min overload 1000 A</td>
                      </tr>
                      <tr>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="text-black space-y-4">
                    <ul className="list-disc pl-5">
                      ...
                      <li>
                        <h4 className="font-bold text-[#5C5649]"><a href="/products/aviation-equipment/ground-supply-equipment/ground-power-unit/electric-ground-power-unit" className="hover:underline" style={{ color: 'inherit' }}>Battery-Electric eGPU</a></h4>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  ...
                  <div className="text-black space-y-4">
                    <ul className="list-disc pl-5">
                      ...
                      <li><h4 className="font-bold text-[#5C5649]">Military Flight Lines</h4>Supports deployed air operations and field servicing – <a href="/products/aviation-equipment/ground-supply-equipment/ground-power-unit/military-ground-power-unit" className="hover:underline" style={{ color: 'inherit' }}>Military Ground Power Unit</a>.</li>
                    </ul>
                  </div>
                </div>
              </div>
                  ...
                  <div className="text-black space-y-4">
                    <ul className="list-disc pl-5">
                      <li>
                        ...
                        Jetsys GPUs deliver clean, tightly regulated <a href="/products/aviation-equipment/ground-supply-equipment/ground-power-unit/28.5vdc-ground-power-unit" className="hover:underline" style={{ color: 'inherit' }}>28.5 V DC</a> and <a href="/products/aviation-equipment/ground-supply-equipment/ground-power-unit/400hz-ground-power-unit" className="hover:underline" style={{ color: 'inherit' }}>115/200 V AC</a> output, eliminating voltage fluctuations that can damage avionics or trigger nuisance faults.
                      </li>
                      <li>
