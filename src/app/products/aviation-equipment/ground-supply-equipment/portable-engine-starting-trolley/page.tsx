    ...
    <div>
      ...
      <div>
       ...
       <div>
              ...
              <section><br></br><br></br>
  <div>
    <h3 className="font-bold text-3xl text-[#5C5649] mb-5">Model Options of Hydraullic Servicing Trolley</h3>
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
      ...
      <div className="text-black space-y-4">
        <ul className="list-disc pl-5">
          ...
          <li>
            <h4 className="font-bold text-[#5C5649]">PESU-28 (Helicopter / Light Turbine)</h4>
            28 VDC supply with high burst current, compact towable trolley, wide-range AC charger, and optional cold-weather kit.
          </li>

          <li>
            <h4 className="font-bold text-[#5C5649]">PESU-24 (Turboprop / GA / Piston)</h4>
      ...
      <div className="text-black space-y-4">
        <ul className="list-disc pl-5">
          ...
          <li>
            <h4 className="font-bold text-[#5C5649]">Advanced Li Pack</h4>
      ...
      <div className="text-black space-y-4">
        <ul className="list-disc pl-5">
          ...
          <li>
            ...
            Available with sealed lead-acid (SLA/AGM) for value or LiFePO₄ for higher power-to-weight ratio and faster recharge times.
          </li>
...
<section><br></br><br></br>
  <div className="mx-auto">
    ...
    <p className="text-gray-700 mb-6">
      Representative values for portable aircraft starting power units. Jetsys Defence offers customized configurations to suit engine type, start profile, and ambient conditions.
    </p>
      ...
      <table className="min-w-full table-auto">
        ...
        <tbody>
          <tr>
            ...
            <td className="px-4 py-2 border-b">24 VDC or 28.5 VDC (model dependent)</td>
          </tr>
          ...
          <tr>
            ...
            <td className="px-4 py-2 border-b">50–100 Ah (SLA/AGM) or 40–80 Ah (LiFePO<sub>4</sub>) equivalent energy</td>
          </tr>
          ...
          <tr>
            ...
            <td className="px-4 py-2 border-b">
              Reverse-polarity, short-circuit, over-temp, over-voltage, fuse/CB protection, master isolator
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="px-4 py-2 border-b">
              Digital voltmeter/SOC, status LEDs, hour/event counters (options)
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="px-4 py-2 border-b">
              Heavy-duty aircraft lead with start plug; optional NATO plug/adapters
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="px-4 py-2 border-b">
              Powder-coated or stainless steel; IP-rated panels; impact bumpers
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="px-4 py-2 border-b">
              Removable trolley with castors &amp; telescopic handle; skid/tow-handle options
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="px-4 py-2 border-b">
              Built to aviation GSE best practice; environmental testing options available
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="px-4 py-2 border-b">
              Compact footprint (~400×300×300 mm module); ~20–40 kg module plus trolley
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
      ...
      <div className="text-black space-y-4">
        <ul className="list-disc pl-5">
          <li>
            ...
            Visual checks, connector cleanliness, SOC/voltage check.
          </li>

          <li>
            <h4 className="font-bold text-[#5C5649]">Weekly</h4>
            Lead integrity inspection, charger self-test, and log start events.
          </li>
        </ul>
      </div>
      ...
      <div className="text-black space-y-4">
        <ul className="list-disc pl-5">
          <li>
            <h4 className="font-bold text-[#5C5649]">Monthly / Quarterly</h4>
            Capacity test (battery health) and firmware/settings review (if applicable).
          </li>

          <li>
            <h4 className="font-bold text-[#5C5649]">Annually</h4>
            Full electrical inspection, load test, meter calibration, and battery replacement plan by cycles/calendar.
          </li>

          <li>
            <h4 className="font-bold text-[#5C5649]">Support</h4>
            Jetsys Defence provides AMCs, calibration, and battery refurbishment programs to maximise uptime.
          </li>
        </ul>
      </div>
...
<section><br></br><br></br>
  <div>
    ...
    <p className="text-black">
      For transparent Portable Engine Starting Trolley price options and current sale bundles (spares kit, extra lead set, cold-weather jacket), 
...
<section><br></br><br></br>
  <div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
      ...
      <div className="text-black space-y-4">
        <ul className="list-disc pl-5">
          <li>Pre-tested Portable Engine Starting Trolley with chosen battery chemistry</li>
      ...
      <div className="text-black space-y-4">
        <ul className="list-disc pl-5">
          ...
          <li>
            ...
            Offered in 12V, 24V, 28.5V, and multi-output versions with optional jumper cables, NATO connectors, and protective covers for rotary and fixed-wing fleets.
          </li>
