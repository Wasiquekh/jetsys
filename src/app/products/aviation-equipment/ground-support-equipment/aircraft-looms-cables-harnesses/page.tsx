            ...
            <div>
                  ...
                  <div className="grid grid-cols-1 gap-8">
                    <div className="text-black space-y-4">
                      <p className="text-black">
                        Our <a href="/products/aviation-equipment/ground-support-equipment/aircraft-looms-cables-harnesses/aircraft-electrical-harness" className="hover:underline" style={{ color: 'inherit' }}>Aircraft Looms, Cables & Harnesses</a> combine optimized conductor selection, high-temperature insulation, EMI/EMC shielding, and robust strain-relief to ensure fault-free operation. From lightweight fly-by-wire bundles to engine-bay high-temp looms, we tailor every assembly to your platform, routing, and maintenance philosophy.
                      </p>
              ...
              <section><br /><br />
                <div className="mx-auto">
                  <h2 className="text-3xl font-bold text-[#5C5649] mb-6">Technical Specifications</h2>
                  <p className="text-gray-700 mb-4">
                    Representative values. Jetsys Defence custom-engineers <a href="/products/aviation-equipment/ground-support-equipment/aircraft-looms-cables-harnesses/aerospace-cable-harness" className="hover:underline" style={{ color: 'inherit' }}>Aircraft Looms, Cables & Harnesses</a> to your environmental, electrical, and routing requirements.
                  </p>
                  ...
                  <div className="grid grid-cols-1 gap-8">
                    <div className="text-black space-y-4">
                      <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>
                          <strong className="text-[#5C5649]"><a href="/products/aviation-equipment/ground-support-equipment/aircraft-looms-cables-harnesses/engine-wiring-harness-aircraft" className="hover:underline" style={{ color: 'inherit' }}>Engine & nacelle harnesses</a> –</strong>
                          High-temperature, vibration-resistant builds with fluid- and abrasion-resistant jacketing.
                        </li>
                        <li>
                          <strong className="text-[#5C5649]"><a href="/products/aviation-equipment/ground-support-equipment/aircraft-looms-cables-harnesses/avionics-wiring-harness" className="hover:underline" style={{ color: 'inherit' }}>Avionics & mission systems</a> –</strong>
                          Impedance-controlled bundles (ARINC, CAN, Ethernet), RF/coax runs, and precision sensor wiring.
                        </li>
                        <li>
                          <strong className="text-[#5C5649]"><a href="/products/aviation-equipment/ground-support-equipment/aircraft-looms-cables-harnesses/landing-gear-wiring-harness" className="hover:underline" style={{ color: 'inherit' }}>Landing gear & actuation</a> –</strong>
                  ...
                  <div className="grid grid-cols-1 gap-8">
                    <div className="text-black space-y-4">
                      <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>
                          <strong className="text-[#5C5649]">Landing gear –</strong>
                          <a href="/products/aviation-equipment/ground-support-equipment/aircraft-looms-cables-harnesses/landing-gear-wiring-harness" className="hover:underline" style={{ color: 'inherit' }}> Instrumentation, brake systems, and actuator wiring.</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div className="text-black space-y-4">
                      <ul className="list-disc pl-5 space-y-2">
                        <li>
                          ...
                          All <a href="/products/aviation-equipment/ground-support-equipment/aircraft-looms-cables-harnesses/defence-aircraft-wiring-harness" className="hover:underline" style={{ color: 'inherit' }}>assemblies</a> are engineered in-house with aerospace-grade quality, precise routing, and weight-optimized architecture.
                        </li>
                        <li>
